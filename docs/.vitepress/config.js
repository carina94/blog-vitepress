      ...
      nav: [ // 页面右上角的导航
          ...
          },
          {
              ...
              items: [ // 可以配置成下拉
                  ...
                  { text: "react", link: "/articles/react/base" },
                  { text: "小程序", link: "/articles/xcx/base" },
                  { text: "uniapp", link: "/articles/uniapp/base" },
                  { text: 'electron', link: '/articles/electron/1' },
              ]
          },
          {
            text: '项目学习',
